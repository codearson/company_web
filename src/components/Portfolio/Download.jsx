            ...
            <div className="content text-center">
              ...
              >
                <h2 className="mb-20">
                  {" "}
                  {rtl
                    ? "قم بالوصول إلى إمكانات عملك اليوم وابحث عن فرصة لتحقيق"
              ...
              <div className="butns mt-70">
                <Link
                  to={rtl ? "/rtl-page-contact" : "/page-contact-app"}
                  className={`btn rounded-pill me-4 fw-bold ${
                    style === "4"
                      ? "bg-blue4 text-white"
                ...
                <Link
                  to={rtl ? "/rtl-page-about" : "/page-price-app"}
                  className={`btn rounded-pill fw-bold ${
                    style === "4"
                      ? "hover-blue4 border-blue4"
                      : "blue5-3Dbutn hover-blue2 sm-butn mx-1"
                  }`}
                  target="_blank"
                >
