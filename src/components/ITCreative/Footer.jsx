    ...
    <footer className="style-7">
      <div className="container">
            ...
            <div className="col-lg-4 border-1 border-end brd-gray">
              <div className="info-logo">
                ...
                <div className="social-links">
                  <a href="https://facebook.com/iteck" target="_blank" rel="noopener noreferrer">
                    <i className="fab fa-facebook-f"></i>
                  </a>
                  <a href="https://twitter.com/iteck" target="_blank" rel="noopener noreferrer">
                    <i className="fab fa-twitter"></i>
                  </a>
                  <a href="https://youtube.com/iteck" target="_blank" rel="noopener noreferrer">
                    <i className="fab fa-youtube"></i>
                  </a>
                  <a href="https://linkedin.com/company/iteck" target="_blank" rel="noopener noreferrer">
        ...
        <div className="foot bg-white p-3 rounded-pill text-center">
          <p> Full Copyright & Design By <a href="https://themescamp.com" target="_blank" rel="noopener noreferrer" className="fw-bold"> @ThemesCamp </a> - 2022 </p>
        </div>
      </div>
